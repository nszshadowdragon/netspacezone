...
export default function CometModal({ show, onCancel, onCommit }) {
  // Hooks at the top
  ...
  function commitComet() {
    ...
    console.log('Comet Committed');
    onCommit({ content: '', advanced, mode: 'Comet' });
  }
